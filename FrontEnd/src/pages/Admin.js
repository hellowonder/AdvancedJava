...
export default function Admin() {
  ...
  return (
    <div className="dashboard-body">
      {/* Navbar_____________________________________________________________________________________________________________ */}
        ...
        <div className="container-fluid mt-0 ">
          <div className="row">
            <div className="col-4 ">
              <div
                style={{ height: "18%" }}
                className="fs-3 mt-3 text-light d-flex justify-content-center align-items-center border border-light border-1 "
              >
                Blank
              </div>
